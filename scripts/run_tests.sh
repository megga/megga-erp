...
MODULES="${TEST_MODULES:-megga_base,megga_qr_export,megga_camt,megga_pain001,megga_tva_ch,megga_rdv,megga_retrocession,megga_dental,megga_dental_rdv,megga_resto,megga_resto_rdv,megga_resto_tva,megga_auto,megga_auto_rdv,megga_auto_occasion,megga_care}"
TAGS="${TEST_TAGS:-/megga_qr_export,/megga_camt,/megga_pain001,/megga_tva_ch,/megga_rdv,/megga_retrocession,/megga_dental,/megga_dental_rdv,/megga_resto,/megga_resto_rdv,/megga_resto_tva,/megga_auto,/megga_auto_rdv,/megga_auto_occasion,/megga_care}"
MIN="${TEST_MIN:-210}"
