...
MODULES="${TEST_MODULES:-megga_base,megga_qr_export,megga_camt,megga_pain001,megga_tva_ch,megga_rdv,megga_dental,megga_dental_rdv,megga_resto,megga_resto_rdv,megga_resto_tva,megga_auto,megga_auto_rdv}"
TAGS="${TEST_TAGS:-/megga_qr_export,/megga_camt,/megga_pain001,/megga_tva_ch,/megga_rdv,/megga_dental,/megga_dental_rdv,/megga_resto,/megga_resto_rdv,/megga_resto_tva,/megga_auto,/megga_auto_rdv}"
MIN="${TEST_MIN:-158}"
