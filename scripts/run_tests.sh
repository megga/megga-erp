...
MODULES="${TEST_MODULES:-megga_base,megga_relances,megga_pilotage,megga_qr_export,megga_camt,megga_pain001,megga_qr_import,megga_tva_ch,megga_rdv,megga_retrocession,megga_dental,megga_dental_rdv,megga_dental_portal,megga_resto,megga_resto_portal,megga_resto_rdv,megga_resto_tva,megga_auto,megga_auto_portal,megga_auto_rdv,megga_auto_occasion,megga_care,megga_care_import}"
TAGS="${TEST_TAGS:-/megga_relances,/megga_pilotage,/megga_qr_export,/megga_camt,/megga_pain001,/megga_qr_import,/megga_tva_ch,/megga_rdv,/megga_retrocession,/megga_dental,/megga_dental_rdv,/megga_dental_portal,/megga_resto,/megga_resto_portal,/megga_resto_rdv,/megga_resto_tva,/megga_auto,/megga_auto_portal,/megga_auto_rdv,/megga_auto_occasion,/megga_care,/megga_care_import}"
MIN="${TEST_MIN:-457}"
